...
public class CowHandler extends Handler
{
	...
	public static final int screen1Id=532;
	...
	public void handleMessage(String message)
	{
		...
		if(footprintText.equals(String.valueOf(FarmerHandler.screen1Id)+","+String.valueOf(1)+","+String.valueOf(2)+","+String.valueOf(CowHandler.screen1Id)))
		{
